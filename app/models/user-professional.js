	...
	{},
	{
			classMethods: {  
				...
				getregisteredUsersTrainer: function(id)
				{
					...
					var sql="select user.userID, user.firstName, user.lastName, user.gender, user.height ,user.profilepic as pic, user.username, userProfessionalRegistration.professionalID, userProfessionalRegistration.id  as prid from user inner join userProfessionalRegistration on user.userID=userProfessionalRegistration.userID where userProfessionalRegistration.professionalID='"+id+"' AND userProfessionalRegistration.isdeleted='0' AND userProfessionalRegistration.status='1'";
                         return sequelize.query(sql, {type: sequelize.QueryTypes.SELECT});
				},
				getregisteredProfessionals: function(id)
				{

					var sql="select user.userID, user.firstName, user.lastName, user.gender, user.height ,user.profilepic as pic, user.username, userProfessionalRegistration.professionalID from user inner join userProfessionalRegistration on user.userID=userProfessionalRegistration.professionalID where userProfessionalRegistration.userID='"+id+"' AND userProfessionalRegistration.isdeleted='0' AND userProfessionalRegistration.status='1'";
                         return sequelize.query(sql, {type: sequelize.QueryTypes.SELECT});
				},
				getUserTrainerDetail: function(userid,pid){ 
					var sql="select user.userID, user.firstName, user.lastName, user.token , user.ic_number, user.username, user.profilepic as pic, user.gender, user.birthday , user.weight, user.height, userProfessionalRegistration.professionalID, userProfessionalRegistration.insertionDate as member_since, weight.weightQty from user  inner join userProfessionalRegistration on user.userID=userProfessionalRegistration.userID left join weight on user.userID= weight.userID where userProfessionalRegistration.professionalID='"+pid+"'  AND userProfessionalRegistration.status='1' AND userProfessionalRegistration.userID='"+userid+"' AND userProfessionalRegistration.isdeleted='0' order by weight.scaleDate desc limit 1";
				     return sequelize.query(sql, {type: sequelize.QueryTypes.SELECT});	
				},
				getCountregistrationReq: function (id) { 
				
				var sql = "SELECT COUNT(user.userID) AS totalReq from user INNER JOIN  userProfessionalRegistration ON user.userID=userProfessionalRegistration.userID WHERE userProfessionalRegistration.professionalID ='"+id+"' AND userProfessionalRegistration.status='0' AND userProfessionalRegistration.isdeleted='0'";
				  return sequelize.query(sql,{ type: sequelize.QueryTypes.SELECT});
				...
				var sql = "SELECT COUNT(userillness.userID) AS totalDiabetes from userillness INNER JOIN  userProfessionalRegistration ON userillness.userID=userProfessionalRegistration.userID WHERE userProfessionalRegistration.professionalID ='"+id+"' AND userProfessionalRegistration.status='1' AND userProfessionalRegistration.isdeleted='0' AND userillness.disease='1'";
				  return sequelize.query(sql,{ type: sequelize.QueryTypes.SELECT});
				
				},
				getCountHypertensionReq: function (id) { 
				
				var sql = "SELECT COUNT(userillness.userID) AS totalHypertension from userillness INNER JOIN  userProfessionalRegistration ON userillness.userID=userProfessionalRegistration.userID WHERE userProfessionalRegistration.professionalID ='"+id+"' AND userProfessionalRegistration.status='1' AND userProfessionalRegistration.isdeleted='0' AND userillness.disease='2'";
				  return sequelize.query(sql,{ type: sequelize.QueryTypes.SELECT});
				
				},
				getCountBothReq: function (id) { 
				
				var sql = "SELECT COUNT(userillness.userID) AS totalPatient from userillness INNER JOIN  userProfessionalRegistration ON userillness.userID=userProfessionalRegistration.userID WHERE userProfessionalRegistration.professionalID ='"+id+"' AND userProfessionalRegistration.status='1' AND userProfessionalRegistration.isdeleted='0' AND userillness.disease='3'";
				  return sequelize.query(sql,{ type: sequelize.QueryTypes.SELECT});
				...
				{
				var sql = "SELECT user.username, user.firstName, user.lastName, user.userID AS userid,userillness.disease,userillness.dietControl,userillness.oralAntidiabetics,userillness.insulin ,userProfessionalRegistration.id as registrationid, userProfessionalRegistration.status from user INNER JOIN  userProfessionalRegistration ON user.userID=userProfessionalRegistration.userID INNER JOIN userillness ON user.userID= userillness.userID WHERE userProfessionalRegistration.professionalID ='"+id+"' AND userProfessionalRegistration.status='1' AND userProfessionalRegistration.isdeleted='0' AND userillness.disease='"+dh+"' AND userillness.dietControl='1'";
                return sequelize.query(sql,{ type: sequelize.QueryTypes.SELECT});
				...
				{
				var sql = "SELECT user.username, user.firstName, user.lastName, user.userID AS userid,userillness.disease,userillness.dietControl,userillness.oralAntidiabetics,userillness.insulin ,userProfessionalRegistration.id as registrationid, userProfessionalRegistration.status from user INNER JOIN  userProfessionalRegistration ON user.userID=userProfessionalRegistration.userID INNER JOIN userillness ON user.userID= userillness.userID WHERE userProfessionalRegistration.professionalID ='"+id+"' AND userProfessionalRegistration.status='1' AND userProfessionalRegistration.isdeleted='0' AND userillness.disease='"+dh+"' AND userillness.oralAntidiabetics='1'"; 
				return sequelize.query(sql,{ type: sequelize.QueryTypes.SELECT}); 
				},
				getdiabetesOADDetails: function (userid)
				{
					var sql="SELECT * FROM  diabetesOAD WHERE userID="+userid+" order by recordDateTime desc";
					return sequelize.query(sql,{ type: sequelize.QueryTypes.SELECT});
					},
				getdiabetesInsulin : function (id, dh)
				{
				var sql = "SELECT user.username, user.firstName, user.lastName, user.userID AS userid,userillness.disease,userillness.dietControl,userillness.oralAntidiabetics,userillness.insulin ,userProfessionalRegistration.id as registrationid, userProfessionalRegistration.status from user INNER JOIN  userProfessionalRegistration ON user.userID=userProfessionalRegistration.userID INNER JOIN userillness ON user.userID= userillness.userID WHERE userProfessionalRegistration.professionalID ='"+id+"' AND userProfessionalRegistration.status='1' AND userProfessionalRegistration.isdeleted='0' AND userillness.disease='"+dh+"' AND userillness.insulin='1'";
				return sequelize.query(sql,{ type: sequelize.QueryTypes.SELECT});
				},
				...
				gethypertensionpatientsNotControlled: function (id, dh) { 
		         ...
		         var sql = "SELECT user.username, user.token, user.firstName, user.lastName, user.userID AS userid,userillness.disease, userillness.notControlledTreatment,userillness.wellControlled ,userProfessionalRegistration.id as registrationid, userProfessionalRegistration.status from user INNER JOIN  userProfessionalRegistration ON user.userID=userProfessionalRegistration.userID INNER JOIN userillness ON user.userID= userillness.userID WHERE userProfessionalRegistration.professionalID ='"+id+"' AND userProfessionalRegistration.status='1' AND userProfessionalRegistration.isdeleted='0' AND userillness.disease='"+dh+"' AND userillness.notControlledTreatment='1'";
				...
				gethypertensionpatientsWellControlled: function (id, dh) { 
		         ...
		         var sql = "SELECT user.username, user.firstName, user.token, user.lastName, user.userID AS userid,userillness.disease, userillness.notControlledTreatment,userillness.wellControlled ,userProfessionalRegistration.id as registrationid, userProfessionalRegistration.status from user INNER JOIN  userProfessionalRegistration ON user.userID=userProfessionalRegistration.userID INNER JOIN userillness ON user.userID= userillness.userID WHERE userProfessionalRegistration.professionalID ='"+id+"' AND userProfessionalRegistration.status='1' AND userProfessionalRegistration.isdeleted='0' AND userillness.disease='"+dh+"' AND userillness.wellControlled='1'";
				...
				var sql="SELECT medicine.medicineName, medicine.id, mymedicinestatus.dateTime, mymedicinestatus.status, case when mymedicinestatus.reason is null then '-' else  mymedicinestatus.reason end as reason, mymedicinestatus.timeTake, mymedicinestatus.userID from mymedicinestatus inner join medicine on mymedicinestatus.myMedicineID=medicine.id where mymedicinestatus.myMedicineID='"+mid+"' and mymedicinestatus.userID='"+id+"' order by mymedicinestatus.id desc"; 
                  return sequelize.query(sql, { type: sequelize.QueryTypes.SELECT});
				} ,
				...
				{
					//var sql="SELECT * FROM userillnessTargetControl WHERE isdeleted=0 AND  userID='"+userID+"'";
				...
				{
					var sql="SELECT (select avg(glucoselevel) FROM umch.glucose WHERE time(recordDateTime) > time('01:00:00') and  time(recordDateTime) < time('07:10:00') and user ='"+email+"' and date(recordDateTime) =date( '"+date+"')) as BreakFastPre, (select notes FROM umch.glucose WHERE time(recordDateTime) > time('01:00:00') and  time(recordDateTime) < time('07:10:00') and user ='"+email+"' and date(recordDateTime) =date( '"+date+"')) as BreakFastPreNote, (select avg(glucoselevel) FROM umch.glucose WHERE time(recordDateTime) > time('07:10:00') and  time(recordDateTime) < time('11:00:00') and user ='"+email+"' and date(recordDateTime) =date( '"+date+"')) as BreakFastPost, (select notes FROM umch.glucose WHERE time(recordDateTime) > time('07:10:00') and  time(recordDateTime) < time('11:00:00') and user ='"+email+"' and date(recordDateTime) =date( '"+date+"')) as BreakFastPostNote, (select avg(glucoselevel) FROM umch.glucose WHERE time(recordDateTime) > time('11:00:00') and  time(recordDateTime) < time('13:10:00') and user ='"+email+"' and date(recordDateTime) =date( '"+date+"')) as LunchPre, (select notes FROM umch.glucose WHERE time(recordDateTime) > time('11:00:00') and  time(recordDateTime) < time('13:10:00') and user ='"+email+"' and date(recordDateTime) =date( '"+date+"')) as LunchPreNote, (select avg(glucoselevel) FROM umch.glucose WHERE time(recordDateTime) > time('13:10:00') and  time(recordDateTime) < time('17:10:00') and user ='"+email+"' and date(recordDateTime) =date( '"+date+"')) as LunchPost, (select notes FROM umch.glucose WHERE time(recordDateTime) > time('13:10:00') and  time(recordDateTime) < time('17:10:00') and user ='"+email+"' and date(recordDateTime) =date( '"+date+"')) as LunchPostNote, (select avg(glucoselevel) FROM umch.glucose WHERE time(recordDateTime) > time('17:10:00') and  time(recordDateTime) < time('20:10:00') and user ='"+email+"' and date(recordDateTime) =date( '"+date+"')) as DinnerPre, (select notes FROM umch.glucose WHERE time(recordDateTime) > time('17:10:00') and  time(recordDateTime) < time('20:10:00') and user ='"+email+"' and date(recordDateTime) =date( '"+date+"')) as DinnerPreNote, (select avg(glucoselevel) FROM umch.glucose WHERE time(recordDateTime) > time('20:10:00') and  time(recordDateTime) < time('23:59:59') and user ='"+email+"' and date(recordDateTime) =date( '"+date+"')) as DinnerPost, (select notes FROM umch.glucose WHERE time(recordDateTime) > time('20:10:00') and  time(recordDateTime) < time('23:59:59') and user ='"+email+"' and date(recordDateTime) =date( '"+date+"')) as DinnerPostNote, date(recordDateTime) as c_date  FROM umch.glucose where user ='"+email+"' and date(recordDateTime) =date( '"+date+"') group by date(recordDateTime)";
					
					return sequelize.query(sql, { type: sequelize.QueryTypes.SELECT});
				},
				getrequirereviewsPatients: function(userID)
				{
					var sql="select user.userID, user.username, user.email, user.firstName, user.lastName, userillness.disease,bp.systolic, bp.diastolic, glucose.glucoselevel from user inner join userillness on user.userID=userillness.userID inner join userProfessionalRegistration on user.userID=userProfessionalRegistration.userID left join carePlanreviewedPatients on user.userID=carePlanreviewedPatients.userID left join bp on user.email=bp.userID left join glucose on user.email=glucose.user where glucoselevel not between 4.4 and 7 and date(glucose.recordDateTime) >= DATE(NOW()) - INTERVAL 8 DAY and date(glucose.recordDateTime) != CURRENT_DATE OR bp.diastolic > 89 OR bp.systolic > 139 and  date(bp.recordTime) >= DATE(NOW()) - INTERVAL 8 DAY and date(bp.recordTime) != CURRENT_DATE and userProfessionalRegistration.status =1 and userProfessionalRegistration.professionalID='"+userID+"' and userillness.disease !=0 and user.userID NOT IN (SELECT userID FROM umch.carePlanreviewedPatients where reviewedDate=CURRENT_DATE) group by user.userID";
					return sequelize.query(sql, { type: sequelize.QueryTypes.SELECT});
				},
				...
				{
					var sql="SELECT id, userID, diet_only_breakfast_pre, diet_only_breakfast_post, diet_only_lunch_pre, diet_only_lunch_post, diet_only_dinner_pre, diet_only_dinner_post, oad_breakfast_pre, oad_breakfast_post, oad_lunch_pre, oad_lunch_post, oad_dinner_pre, oad_dinner_post, insulin_breakfast_pre,insulin_breakfast_post, insulin_lunch_pre, insulin_lunch_post, insulin_dinner_pre, insulin_dinner_post   FROM umch.userillnessMeasurements where userID='"+userID+"' and isdeleted=0 and  diabetes_day_measurement like '%"+day+"%' and CURRENT_DATE >= from_diabetes and CURRENT_DATE <= to_diabetes;";
					return sequelize.query(sql, { type: sequelize.QueryTypes.SELECT});
				}, 
				getTodayTasksHypertension: function(userID, day)
				{
					var sql="SELECT id, userID, not_controlled_treatment, well_controlled FROM umch.userillnessMeasurements where userID='"+userID+"' and isdeleted=0 and hypertension_day_measurement like '%"+day+"%' and CURRENT_DATE >= from_hypertension and CURRENT_DATE <= to_hypertension;";
					return sequelize.query(sql, { type: sequelize.QueryTypes.SELECT});
				}, 
				getTodayTasksMedication: function(userID, day)
				{
					var sql="SELECT mymedicine.id, mymedicine.userID, medicine.medicineName , mymedicine.timingPerDay as todaytime  FROM umch.mymedicine inner join medicine on mymedicine.medicineID=medicine.id where mymedicine.userID='"+userID+"' and mymedicine.days like '%"+day+"%' and CURRENT_DATE >= mymedicine.startDate and CURRENT_DATE <= mymedicine.endDate;";
					return sequelize.query(sql, { type: sequelize.QueryTypes.SELECT});
				},
				getTasksDiabetes: function(userID)
				{
					var sql="SELECT id, userID, diet_only_breakfast_pre, diet_only_breakfast_post, diet_only_lunch_pre, diet_only_lunch_post, diet_only_dinner_pre, diet_only_dinner_post, oad_breakfast_pre, oad_breakfast_post, oad_lunch_pre, oad_lunch_post, oad_dinner_pre, oad_dinner_post, insulin_breakfast_pre,insulin_breakfast_post, insulin_lunch_pre, insulin_lunch_post, insulin_dinner_pre, insulin_dinner_post, diabetes_day_measurement, from_diabetes as startDate, to_diabetes as endDate   FROM umch.userillnessMeasurements where userID='"+userID+"' and isdeleted=0 ";
					return sequelize.query(sql, { type: sequelize.QueryTypes.SELECT});
				}, 
				getTasksHypertension: function(userID)
				{
					var sql="SELECT id, userID, not_controlled_treatment, well_controlled, hypertension_day_measurement, from_hypertension as startDate, to_hypertension as endDate FROM umch.userillnessMeasurements where userID='"+userID+"' and isdeleted=0";
					return sequelize.query(sql, { type: sequelize.QueryTypes.SELECT});
				}, 
				getTasksMedication: function(userID)
				{
					var sql="SELECT mymedicine.id, mymedicine.userID, medicine.medicineName , mymedicine.timingPerDay as todaytime, mymedicine.days, mymedicine.startDate , mymedicine.endDate FROM umch.mymedicine inner join medicine on mymedicine.medicineID=medicine.id where mymedicine.userID='"+userID+"'";
					return sequelize.query(sql, { type: sequelize.QueryTypes.SELECT});
				},
