	...
	db.user.authUser(token).then(function(response) {
			if (!!token) {
				if (response != '' && response != null) {
					...
					var sql = "INSERT INTO temperatureGoal (userid, goalBodyTemperature_start, goalBodyTemperature_end, notification ) values ";
					...
					for (var i = 0; i < total - 1; i++) {
						...
						sql += "('" + userid + "','" + goalBodyTemperature_start + "','" + goalBodyTemperature_end + "','" + notification + "'),";
	...
	db.user.authUser(token).then(function(response) {
			if (!!token) {
				if (response != '' && response != null) {
					...
					var sql = "INSERT INTO heartrateGoal (userid, goalHeartRate_Start, goalHeartRate_End, notification ) values ";
					...
					for (var i = 0; i < total - 1; i++) {
						...
						sql += "('" + userid + "','" + goalHeartRate_Start + "','" + goalHeartRate_End + "','" + notification + "'),";
	...
	db.user.authUser(token).then(function(response) {
			if (!!token) {
				if (response != '' && response != null) {
					...
					var sql = "INSERT INTO oxygenGoal (userid, goalOxygen_Start, goalOxygen_End, notification ) values ";
					...
					for (var i = 0; i < total - 1; i++) {
						...
						sql += "('" + userid + "','" + goalOxygen_Start + "','" + goalOxygen_End + "','" + notification + "'),";
